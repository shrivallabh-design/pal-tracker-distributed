...
namespace Backlog.ProjectClient
{
    public class ProjectClient : IProjectClient
    {
        ...
        private readonly System.Func<Task<string>> _accessTokenFn;
        private readonly IDictionary<long, ProjectInfo> _projectCache = new Dictionary<long, ProjectInfo>();

        public ProjectClient(HttpClient client, ILogger<ProjectClient> logger,System.Func<Task<string>> accessTokenFn)
        {
            _client = client;
            _logger = logger;
